document.addEventListener("DOMContentLoaded", () => {
    ...
    var content = {
        ...
        uslugePromidzbah3: document.querySelector("#review h3"),
        uslugePromidzbap: document.querySelector("#review p"),
        uslugeMarketingh3: document.querySelector("#marketing h3"),
        uslugepMarketingp: document.querySelector("#marketing p"),
        uslugeEdukacijah3: document.querySelector("#education h3"),
        uslugeEdukacijap: document.querySelector("#education p"),
    ...
    const engTranslations = {
        ...
        oNamap: "After several years of using, learning and exploring Facebook, Instagram & YouTube, we decided to share all knowledge with you!<br /> Today you need more than „knowing the basic“ to advertise Your product or service on social networks.<br /><span>Don't waste your money!</span>",
        uslugeh1: "Services",
